...
class CommentSection
{
    ...
    private function createCommentSection()
    {
        ...
        $profileButton = ButtonProvider::createUserProfileButtonIfNotLoggedIn($this->con, $postedBy);
        $commentAction = "postComment(this, \"$postedBy\", $videoId, null, \"comments\")";
        $commentButton = ButtonProvider::createButton("COMMENT", "postComment", null, $commentAction);
